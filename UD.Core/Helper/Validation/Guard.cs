namespace UD.Core.Helper.Validation
{
    ...
    public sealed class Guard
    {
        ...
        public static void ThrowIfEmpty(string value, string argName)
        {
            ...
            {
                if (ValidationChecks.IsEnglishDefaultThreadCurrentUICulture) { throw new ArgumentNullException(argName, $"The argument \"{argName}\" cannot be null or just a space!"); }
        ...
        public static void ThrowIfEmpty(Guid guid, string argName)
        {
            if (guid == Guid.Empty)
            {
                if (ValidationChecks.IsEnglishDefaultThreadCurrentUICulture) { throw new ArgumentNullException(argName, $"The argument \"{argName}\" cannot be \"{Guid.Empty}\"!"); }
        ...
        public static void ThrowIfEmpty<T>(ICollection<T> collection, string argName)
        {
            ...
            {
                if (ValidationChecks.IsEnglishDefaultThreadCurrentUICulture) { throw new ArgumentNullException(argName, $"The argument \"{argName}\" cannot be null and must contain at least one item!"); }
        ...
        public static void ThrowIfNotValidJson(string json, JTokenType jTokenType, string argName)
        {
            ...
            {
                if (ValidationChecks.IsEnglishDefaultThreadCurrentUICulture) { throw new JsonReaderException($"The argument \"{argName}\" must be in \"JSON\" format and of type \"{typeof(JTokenType).FullName}\"!"); }
        ...
        public static void ThrowIfNotValidPhoneNumberTR(string phoneNumberTR, string argName)
        {
            ...
            {
                if (ValidationChecks.IsEnglishDefaultThreadCurrentUICulture) { throw new ArgumentException($"The argument \"{argName}\" must be a valid phone number in the format of (xxx) xxx-xxxx!", argName); }
        ...
        public static void ThrowIfNotValidTCKN(long tckn, string argName)
        {
            ...
            {
                if (ValidationChecks.IsEnglishDefaultThreadCurrentUICulture) { throw new ArgumentException($"The argument \"{argName}\" must be in the format of Turkish Republic Identification Number!", argName); }
        ...
        public static void ThrowIfNotValidVKN(long vkn, string argName)
        {
            ...
            {
                if (ValidationChecks.IsEnglishDefaultThreadCurrentUICulture) { throw new ArgumentException($"The argument \"{argName}\" must be in the format of Turkish Republic Tax Identity Number!", argName); }
        ...
        public static void ThrowIfNotValidISBN(string isbn, string argName)
        {
            ...
            {
                if (ValidationChecks.IsEnglishDefaultThreadCurrentUICulture) { throw new ArgumentException($"The argument \"{argName}\" must be in the format of {TitleConstants.Isbn}!", argName); }
        ...
        public static void ThrowIfNotValidMAC(string mac, string argName)
        {
            ...
            {
                if (ValidationChecks.IsEnglishDefaultThreadCurrentUICulture) { throw new ArgumentException($"The argument \"{argName}\" must be in the format of a valid MAC address!", argName); }
        ...
        public static void ThrowIfNotValidMail(string mail, string argName)
        {
            if (!mail.IsMail())
            {
                if (ValidationChecks.IsEnglishDefaultThreadCurrentUICulture) { throw new ArgumentException($"The argument \"{argName}\" must be in the format of an e-Mail address!", argName); }
        ...
        public static void ThrowIfNotValidUri(string uriString, string argName)
        {
            if (!uriString.IsUri())
            {
                if (ValidationChecks.IsEnglishDefaultThreadCurrentUICulture) { throw new ArgumentException($"The argument \"{argName}\" must be in a valid URL format!", argName); }
        ...
        public static void ThrowIfNotValidIPAddress(string ipString, string argName)
        {
            ...
            {
                if (ValidationChecks.IsEnglishDefaultThreadCurrentUICulture) { throw new ArgumentException($"The argument \"{argName}\" must be in a valid IP address format!", argName); }
        ...
        public static void ThrowIfNotValidOutOfLength(string value, int maxLength, string argName)
        {
            ...
            if (l > maxLength)
            {
                if (ValidationChecks.IsEnglishDefaultThreadCurrentUICulture) { throw new ArgumentException($"The argument \"{argName}\" cannot be longer than \"{maxLength}\" characters!", argName); }
        ...
        public static void ThrowIfValidIncludes<T>(string argName, T value, params T[] values)
        {
            ...
            {
                if (ValidationChecks.IsEnglishDefaultThreadCurrentUICulture) { throw new ArgumentOutOfRangeException(argName, $"The argument \"{argName}\" cannot be one of the following values: \"{String.Join(", ", values)}\"!"); }
        ...
        public static void ThrowIfNotValidIncludes<T>(string argName, T value, params T[] values)
        {
            if (!value.Includes(values))
            {
                if (ValidationChecks.IsEnglishDefaultThreadCurrentUICulture) { throw new ArgumentOutOfRangeException(argName, $"The argument \"{argName}\" can only be one of the following values: \"{String.Join(", ", values)}\"!"); }
        ...
        public static void ThrowIfNotValidRange<TKey>(TKey value, TKey min, TKey max, string argName) where TKey : struct, IComparable<TKey>
        {
            ...
            {
                if (ValidationChecks.IsEnglishDefaultThreadCurrentUICulture) { throw new ArgumentOutOfRangeException(argName, $"The argument \"{argName}\" must be between the values of [{min} - {max}]!"); }
        ...
        public static void ThrowIfZero<TKey>(TKey value, string argName) where TKey : struct, IComparable<TKey>
        {
            ...
            {
                if (ValidationChecks.IsEnglishDefaultThreadCurrentUICulture) { throw new ArgumentException($"The argument \"{argName}\" cannot be \"0 (zero)\"!", argName); }
        ...
        public static void ThrowIfNegative<TKey>(TKey value, string argName) where TKey : struct, IComparable<TKey>
        {
            if (value.CompareTo(default) < 0)
            {
                if (ValidationChecks.IsEnglishDefaultThreadCurrentUICulture) { throw new ArgumentOutOfRangeException(argName, $"The argument \"{argName}\" cannot be negative!"); }
        ...
        public static void ThrowIfNotValidEnumDefined(Type enumType, object value, string argName)
        {
            ...
            if (!enumType.IsEnum)
            {
                if (ValidationChecks.IsEnglishDefaultThreadCurrentUICulture) { throw new ArgumentException($"The argument \"{nameof(enumType)}\" must be a valid \"{nameof(Enum)}\" type!", nameof(enumType)); }
            ...
            {
                if (ValidationChecks.IsEnglishDefaultThreadCurrentUICulture) { throw new ArgumentException($"The argument \"{argName}\" provided for \"{enumType.FullName}\" is invalid!", argName); }
