    ...
    public sealed class ISBNHelper
    {
        ...
        public string Isbn10
        {
            ...
            set
            {
                ...
                if (ValidationChecks.IsEnglishDefaultThreadCurrentUICulture) { throw new NotSupportedException("ISBN is incompatible!"); }
        ...
        public static string Convert10to13(string isbn)
        {
            ...
            if (ValidationChecks.IsEnglishDefaultThreadCurrentUICulture) { throw new ArgumentException($"{nameof(isbn)} value must be 10 characters long!", nameof(isbn)); }
        ...
        public static string Convert13to10(string isbn)
        {
            ...
            if (ValidationChecks.IsEnglishDefaultThreadCurrentUICulture) { throw new ArgumentException($"{nameof(isbn)} value must be 13 characters long!", nameof(isbn)); }
