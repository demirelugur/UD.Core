    ...
    public sealed class BogusGenericFakeDataGenerator
    {
        ...
        private object createfakeinstance(string parametername, Type type, Faker faker)
        {
            ...
            if (type == typeof(string))
            {
                ...
                if (parametername.Includes("kuladi", "username")) { return this.createmail(faker).User; }
                if (parametername.Includes("eposta", "email")) { return this.createmail(faker).Address; }
            ...
            if (type == typeof(MailAddress)) { return this.createmail(faker); }
