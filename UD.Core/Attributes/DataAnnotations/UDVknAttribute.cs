namespace UD.Core.Attributes.DataAnnotations
{
    ...
    public sealed class UDVknAttribute : ValidationAttribute
    {
        ...
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            return new(this.ErrorMessage.CoalesceOrDefault($"{validationContext.DisplayName}, T.C. Vergi Kimlik Numarası biçimine uygun olmalıdır!"), new[] { validationContext.MemberName });
        }
    }
}