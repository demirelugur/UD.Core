namespace UD.Core.Extensions
{
    ...
    public static class IOExtensions
    {
        ...
        public static long GetSize(this DirectoryInfo source, string searchPattern = "*") => (source.Exists ? source.GetFiles(searchPattern, SearchOption.AllDirectories).Sum(f => f.Length) : 0);
    }
}