namespace UD.Core.Extensions
{
    ...
    public static class UriExtensions
    {
        ...
        /// </summary>
        public static async Task<(bool statuswarning, byte[] databinary, string mimetype, Exception? ex)> GetBinaryDataAsync(this Uri uri, TimeSpan timeout, CancellationToken cancellationtoken = default)
        {
            Guard.CheckNull(uri, nameof(uri));
            using (var client = new HttpClient
            {
